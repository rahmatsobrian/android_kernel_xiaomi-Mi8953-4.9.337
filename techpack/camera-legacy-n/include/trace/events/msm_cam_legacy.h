 ...
 */
#undef TRACE_SYSTEM
#define TRACE_SYSTEM msm_cam_legacy
...
TRACE_EVENT(legacy_n_msm_cam_isp_overflow,
...
TRACE_EVENT(legacy_n_msm_cam_tasklet_debug_dump,
...
TRACE_EVENT(legacy_n_msm_cam_ping_pong_debug_dump,
...
TRACE_EVENT(legacy_n_msm_cam_string,
...
TRACE_EVENT(legacy_n_msm_cam_isp_bufcount,
	TP_PROTO(const char *str,
	unsigned int vfe_id,
