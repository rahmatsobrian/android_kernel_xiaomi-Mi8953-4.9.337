...
int legacy_n_msm_flash_probe(struct platform_device *pdev, const void *data);

int32_t legacy_n_msm_led_flash_create_v4lsubdev(struct platform_device *pdev,
	void *data);
int32_t legacy_n_msm_led_i2c_flash_create_v4lsubdev(void *data);
...
int32_t legacy_n_msm_led_torch_create_classdev(struct platform_device *pdev,
	void *data);
