...
int32_t legacy_n_msm_camera_tz_i2c_power_up(
	struct msm_camera_i2c_client *client)
{
	int32_t rc = -EFAULT;
	int32_t sensor_id = msm_camera_tz_i2c_is_sensor_secure(client);
...
int32_t legacy_n_msm_camera_tz_i2c_power_down(
	struct msm_camera_i2c_client *client)
{
	int32_t rc = -EFAULT;
	int32_t sensor_id = msm_camera_tz_i2c_is_sensor_secure(client);
...
int32_t legacy_n_msm_camera_tz_i2c_register_sensor(
	void *s_ctrl_p)
{
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_read, client, addr, data, data_type);
}
	...
	uint32_t addr, uint8_t *data, uint32_t num_byte)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_read_seq, client, addr, data, num_byte);
}
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write, client, addr, data, data_type);
}
	...
	uint32_t addr, uint8_t *data, uint32_t num_byte)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_seq, client, addr, data, num_byte);
}
	...
	struct msm_camera_i2c_reg_setting *write_setting)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_table_async, client, write_setting);
}
	...
	struct msm_camera_i2c_reg_setting *write_setting)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_table_sync, client, write_setting);
}
	...
	struct msm_camera_i2c_reg_setting *write_setting)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_table_sync_block, client,
			write_setting);
}
	...
	struct msm_camera_i2c_reg_setting *write_setting)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_table, client, write_setting);
}
	...
	struct msm_camera_i2c_seq_reg_setting *write_setting)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_seq_table, client, write_setting);
}
	...
	struct msm_camera_i2c_reg_setting *write_setting)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_table_w_microdelay, client,
			write_setting);
}
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_poll, client, addr, data, data_type);
}
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_camera_cci_i2c_write_conf_tbl, client, reg_conf_tbl, size,
			data_type);
}
	...
	uint16_t cci_cmd)
{
	...
	return TZ_I2C_FN_RETURN(rc,
		legacy_n_msm_sensor_cci_i2c_util, client, cci_cmd);
}
