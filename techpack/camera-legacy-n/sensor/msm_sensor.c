...
int32_t legacy_n_msm_sensor_free_sensor_data(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (s_ctrl->sensor_device_type == MSM_CAMERA_I2C_DEVICE) {
		...
		legacy_n_msm_camera_put_clk_info(s_ctrl->pdev,
			&s_ctrl->sensordata->power_info.clk_info,
			&s_ctrl->sensordata->power_info.clk_ptr,
			s_ctrl->sensordata->power_info.clk_info_size);
	}
...
int legacy_n_msm_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (s_ctrl->is_secure)
		legacy_n_msm_camera_tz_i2c_power_down(sensor_i2c_client);

	return legacy_n_msm_camera_power_down(power_info, sensor_device_type,
		sensor_i2c_client);
}
...
int legacy_n_msm_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	for (retry = 0; retry < 3; retry++) {
		if (s_ctrl->is_secure) {
			rc = legacy_n_msm_camera_tz_i2c_power_up(sensor_i2c_client);
			if (rc < 0) {
		...
		rc = legacy_n_msm_camera_power_up(power_info, s_ctrl->sensor_device_type,
			sensor_i2c_client);
		if (rc < 0)
			return rc;
		rc = legacy_n_msm_sensor_check_id(s_ctrl);
		if (rc < 0) {
			legacy_n_msm_camera_power_down(power_info,
...
int legacy_n_msm_sensor_check_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (s_ctrl->func_tbl->sensor_match_id)
		...
		rc = legacy_n_msm_sensor_match_id(s_ctrl);
	if (rc < 0)
...
static struct msm_sensor_fn_t msm_sensor_func_tbl = {
	.sensor_config = legacy_n_msm_sensor_config,
#ifdef CONFIG_COMPAT
	.sensor_config32 = msm_sensor_config32,
#endif
	.sensor_power_up = legacy_n_msm_sensor_power_up,
	.sensor_power_down = legacy_n_msm_sensor_power_down,
	.sensor_match_id = legacy_n_msm_sensor_match_id,
};
...
static struct msm_camera_i2c_fn_t msm_sensor_cci_func_tbl = {
	...
	.i2c_write_conf_tbl = legacy_n_msm_camera_cci_i2c_write_conf_tbl,
	.i2c_write_table_async = legacy_n_msm_camera_cci_i2c_write_table_async,
	.i2c_write_table_sync = legacy_n_msm_camera_cci_i2c_write_table_sync,
	.i2c_write_table_sync_block = legacy_n_msm_camera_cci_i2c_write_table_sync_block,
...
static struct msm_camera_i2c_fn_t msm_sensor_qup_func_tbl = {
	...
	.i2c_write_conf_tbl = legacy_n_msm_camera_qup_i2c_write_conf_tbl,
	.i2c_write_table_async = legacy_n_msm_camera_qup_i2c_write_table,
	.i2c_write_table_sync = legacy_n_msm_camera_qup_i2c_write_table,
	.i2c_write_table_sync_block = legacy_n_msm_camera_qup_i2c_write_table,
};

static struct msm_camera_i2c_fn_t msm_sensor_secure_func_tbl = {
	.i2c_read = legacy_n_msm_camera_tz_i2c_read,
	.i2c_read_seq = legacy_n_msm_camera_tz_i2c_read_seq,
	.i2c_write = legacy_n_msm_camera_tz_i2c_write,
	.i2c_write_table = legacy_n_msm_camera_tz_i2c_write_table,
	.i2c_write_seq_table = legacy_n_msm_camera_tz_i2c_write_seq_table,
	.i2c_write_table_w_microdelay =
		legacy_n_msm_camera_tz_i2c_write_table_w_microdelay,
	.i2c_util = legacy_n_msm_sensor_tz_i2c_util,
	.i2c_write_conf_tbl = legacy_n_msm_camera_tz_i2c_write_conf_tbl,
	.i2c_write_table_async = legacy_n_msm_camera_tz_i2c_write_table_async,
	.i2c_write_table_sync = legacy_n_msm_camera_tz_i2c_write_table_sync,
	.i2c_write_table_sync_block = legacy_n_msm_camera_tz_i2c_write_table_sync_block,
};
...
int32_t legacy_n_msm_sensor_init_default_params(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (s_ctrl->sensor_device_type == MSM_CAMERA_PLATFORM_DEVICE) {
		...
		if (s_ctrl->is_secure)
			legacy_n_msm_camera_tz_i2c_register_sensor((void *)s_ctrl);
