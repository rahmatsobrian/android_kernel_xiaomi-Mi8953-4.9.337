...
static struct ctl_table xiaomi_msm8953_touchscreen_files[] = {
	{
		...
		.maxlen		= sizeof(int),
		.mode		= 0666,
		.proc_handler	= xiaomi_msm8953_touchscreen_toggle_enable_dt2w,
	},
	{
		.procname	= "disable_keys",
		.data		= &xiaomi_msm8953_touchscreen_disable_keys_val,
		.maxlen		= sizeof(int),
		.mode		= 0666,
		.proc_handler	= xiaomi_msm8953_touchscreen_toggle_disable_keys,
	},
	{ }
};
